...
from programmingtheiot.cda.emulated.FireExtinguisherEmulatorTask import FireExtinguisherEmulatorTask



class FireExtinguisherActuatorEmulatorManagerTest(unittest.TestCase):
	"""
	...
	def setUpClass(self):
		...
		logging.info("Testing FireExtinguisherActuatorAdapterManager class [using SenseHAT emulator]...")

		self.feeSimTask = FireExtinguisherEmulatorTask()
